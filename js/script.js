...
$("header nav ul li a").click(function(){
    ...
    if(oknoPrzegladarki < 1200) {
        ...
        pull.removeClass('nav-mobile-open');
    }
});
...
$(document).ready(function() {
    ...
    $('.know-more a').click(function() {
        var hash = $(this).attr('href');
        $('html, body').stop().animate({
            scrollTop: $(hash).offset().top-topMenuHeight
        }, 300);
        return false;
    });
    ...
    $('.agent-tabs ul li').click(function(){
        ...
        $('.agent-tabs .wrapper-tabs .content-tabs').hide();
        $('.agent-tabs .wrapper-tabs .content-tabs').eq(numtab).fadeIn();
    });
...
let countDown = new Date('Sep 2, 2017 00:00:00').getTime(),
